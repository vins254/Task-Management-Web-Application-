            ...
            <div class="input-box">
                ...
                <div class="input-field">
                    ...
                    <select name="user_role" id="user_role">
                        ...
                        <option value="manager" <?php if($row['user_role']=="Project Manager"){echo "selected";} ?>>Project Manager</option>
                        <option value="employee" <?php if($row['user_role']=="Employee"){echo "selected";} ?> >Employee</option>
                    </select>
                </div>
                <div class="input-field">
